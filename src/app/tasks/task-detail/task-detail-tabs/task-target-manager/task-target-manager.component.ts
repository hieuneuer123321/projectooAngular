...
@Component({
  selector: 'app-task-target-manager',
  templateUrl: './task-target-manager.component.html',
  styleUrls: ['./task-target-manager.component.css']
})
export class TaskTargetManagerComponent implements OnInit {
